  ...
  return (
    <footer style={{ background: 'var(--surface-0)' }}>
          ...
          <div className="grid grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-2.5">
                {[['/', 'Inicio'],['/servicios','Servicios'],['/demos','Demos'],['/nosotros','Nosotros'],['/contacto','Contacto']].map(([href, label]) => (
                  <li key={href}>
      ...
      <div className="container-wide py-5 flex flex-col sm:flex-row items-center justify-between gap-2">
        <p className="text-xs" style={{ color: 'var(--text-muted)' }}>© {new Date().getFullYear()} GiaTech. Todos los derechos reservados.</p>
