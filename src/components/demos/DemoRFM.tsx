...
const segmentColors: Record<string, string> = {
  Champions: '#166534', Leales: '#1d4ed8', 'En Riesgo': '#d97706',
  Potenciales: '#7c3aed', Nuevos: '#0891b2', Perdidos: '#dc2626',
}
const churnByCanal = [
  { canal: 'eCommerce', churn: 0.28 }, { canal: 'App', churn: 0.18 },
  { canal: 'Sucursal', churn: 0.45 }, { canal: 'Telefónico', churn: 0.57 },
]
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        <div className="card p-5">
          <div className="text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>Evolución de segmentos</div>
      ...
      <div className="card p-5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
          <div>
            <div className="text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>Detalle de clientes</div>
            <div className="text-xs" style={{ color: 'var(--text-muted)' }}>{filtered.length} clientes</div>
          </div>
          <div className="flex gap-1.5 flex-wrap">
            {['Todos','eCommerce','App','Sucursal','Telefónico'].map(ch => (
      ...
      <div className="card p-5">
        <div className="text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>Top 5 — Mayor riesgo</div>
